...
\draw [/lt2ti/Net](12.0,-2.5)to[*short,-, color=netcolor] (12.0,-2.5);% wire w5_w7 end
\draw [/lt2ti/Net](14.0,-4.5) --  (14.0,-2.5) -- (12.0,-2.5); % wire w5_w7 polyline 
...
\draw [/lt2ti/Net](8.0,-9.0)to[*short,-*, color=netcolor] (8.0,-8.5);% wire w12
 \draw (8.0, -9.0) node[rground, xscale=1, yscale=1, rotate=0, ] (undefined) {};%  (undefined)++(0.0,0.0) node {undefined }; % component "circuiTikz\gnd" "undefined" 
  ...
  \draw (12.0, -2.5) to[*resistor, l^=R2, a_=, -, ] (9.5,-2.5){}; %\node [] at (12.5,-2.0) {x}; % component "res" "R2" 
